...
Responsable de dispositif, Richard Dutang : \textbf{06 12 31 86 00}\\\\
...
\multicolumn{4}{|c}{\centering\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_secu_1}}  & \multicolumn{4}{c}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_secu_2}} & \multicolumn{4}{c|}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_secu_3}} \\
\multicolumn{4}{|c}{Arthur SAUNIER}  & \multicolumn{4}{c}{Ludovic GIRY} & \multicolumn{4}{c|}{Loïc JEGOU} \\
\multicolumn{4}{|c}{06 25 53 25 79}  & \multicolumn{4}{c}{06 58 09 61 40} & \multicolumn{4}{c|}{06 58 17 07 39} \\

\hline

\multicolumn{3}{|m{4cm}|}{} & \multicolumn{3}{m{4cm}|}{} & \multicolumn{3}{m{4cm}}{} & \multicolumn{3}{m{4cm}|}{}\\
\multicolumn{3}{|c|}{\bf Trésorière} & \multicolumn{3}{c|}{\bf Responsable Billetterie} & \multicolumn{6}{c|}{\bf Responsables Barrières}\\
...
\multicolumn{3}{|c|}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Tresorier}} & \multicolumn{3}{c|}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_billetterie}} & \multicolumn{3}{c}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_barriere_1}} & \multicolumn{3}{c|}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_barriere_2}}\\
...
\multicolumn{3}{|c}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_humain_1}} & \multicolumn{3}{c|}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_humain_2}} & \multicolumn{3}{c}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_bar_1}} & \multicolumn{3}{c|}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_bar_2}}\\
\multicolumn{3}{|c}{Pedro GUEDES} & \multicolumn{3}{c|}{Elsa GASCON} & \multicolumn{3}{c}{Alexis LUZY} & \multicolumn{3}{c|}{Thomas GEORGES}\\
\multicolumn{3}{|c}{07 83 70 31 77} & \multicolumn{3}{c|}{06 88 13 16 72} & \multicolumn{3}{c}{07 61 09 64 48} & \multicolumn{3}{c|}{06 32 32 00 50}\\
\end{supertabular}
...
\multicolumn{4}{|m{5.33cm}}{\rule{0pt}{2ex}} & \multicolumn{4}{m{5.33cm}}{} & \multicolumn{4}{m{5.33cm}|}{} \\
\multicolumn{4}{|c}{\centering\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_catering_1}}  & \multicolumn{4}{c}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_catering_2}} & \multicolumn{4}{c|}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_catering_3}} \\
...
\multicolumn{4}{|m{5.33cm}}{\rule{0pt}{2ex}} & \multicolumn{4}{m{5.33cm}}{} & \multicolumn{4}{m{5.33cm}|}{} \\
\multicolumn{4}{|c}{\centering\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_signa}}  & \multicolumn{4}{c}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_deco_1}} & \multicolumn{4}{c|}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_deco_2}} \\
...
\multicolumn{4}{|m{5.33cm}}{\rule{0pt}{2ex}} & \multicolumn{4}{m{5.33cm}}{} & \multicolumn{4}{m{5.33cm}|}{} \\
\multicolumn{4}{|c}{\centering\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_log_2}}  & \multicolumn{4}{c}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_log_1}} & \multicolumn{4}{c|}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_log_3}} \\
...
\multicolumn{4}{|m{5.33cm}}{\rule{0pt}{2ex}} & \multicolumn{4}{m{5.33cm}}{} & \multicolumn{4}{m{5.33cm}|}{} \\
\multicolumn{4}{|c}{\centering\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_concert_1}}  & \multicolumn{4}{c}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_concert_2}} & \multicolumn{4}{c|}{\includegraphics[angle=270,totalheight=4cm]{Annexes/Trombi_orgas/Orga_concert_3}} \\
...
Il s’appuie également sur les recommandations décrites dans la circulaire NOR/INT/E/88/00157/C du 20 avril 1988 relative à la sécurité des grands rassemblements. \\

Les mesures mises en place dans le cadre du plan Vigipirate y sont aussi exposées.
...
L'objectif de ce dossier est de présenter en détail le dispositif de sécurité mis en place afin d'éviter les éventuels risques et le cas échéant minimiser leur impact. \\\\
...
\begin{minipage}[c]{.48\linewidth}
		\begin{center}
      \includegraphics[width=7.5cm]{Annexes/Images/prez4}
		\end{center}
\end{minipage}
\newpage
...
\midrule
\vspace{1.8cm}
Nouvelles animations & Kart à pédales & Un circuit de karts à pédales sera installé sur les terrains de tennis. Les bordures de pistes seront matérialisées par des structures gonflables. & \ref{kart_a_pedales}&\pageref{kart_a_pedales}\\
\cmidrule{2-5}
...
\cmidrule{2-5}
 & Bobine Tesla & Une bobine Tesla qui produit des éclairs sera installée sur le terrain stabilisé au nord de la piscine avant le feu d'artifice. Des dispositifs de sécurité sont mis en place à ce sujet. & \ref{bobine_tesla} & \pageref{bobine_tesla}\\
\midrule
Accessibilité & Cabinet d'aisance & L'emplacement du cabinet d'aisance pour les PMR a été modifié. & \ref{toilette_PMR}&\pageref{toilette_PMR}\\
\bottomrule
...
\begin{center}
	...
	\captionof{figure}{\label{refPlanERP}Plan de l'ERP édition 2019}
\end{center}
...
\begin{center}
	\includegraphics[scale=0.6]{Annexes/Images/concert2}
\end{center}
\vspace{10mm}
\begin{center}
	\includegraphics[width=9cm]{Annexes/Images/concert1}
\end{center}
\newpage
...
Lors de la manifestation des 17, 18 et 19 mai 2019, ces bâtiments seront vides d’effectif public, seuls le PC sécurité, le poste de secours ainsi que les loges des artistes seront dans ces locaux. 
...
\subsubsection{Gros mobilier, agencement principal (AM 16)}

\textbf{Podium interplateau: }\\

Cette année, le podium interplateau sera placé au milieu de la Zone de Concerts.

Il sera entouré de barrières type Vauban pour éviter que le public n'y ait accès et sera surveillé en permanence par un agent de sûreté.\\

\begin{center}
	\includegraphics[width=.8\textwidth,keepaspectratio]{Exports/Plan_24h_45eme-Zoom_Podium}
	\captionof{figure}{Disposition du podium interplateau}
\end{center}

\textbf{Tours Layher: }\\
Trois tours Layher de tailles différentes vont être installées sur la zone. Elles seront utilisées comme moyens de signalisation et décoration.
Les plans de ces tours sont donnés en annexe (section \ref{Tour_Layher}).

\begin{center}
	\includegraphics[width=.6\textwidth,keepaspectratio]{Exports/Plan_24h_45eme-Tour_Layher_Nord}
	\captionof{figure}{Disposition des tour Layher au nord de la zone}
	\includegraphics[width=.6\textwidth,keepaspectratio]{Exports/Plan_24h_45eme-Tour_Layher_Sud}
	\captionof{figure}{Disposition des tour Layher au sud de la zone}
\end{center}

Les deux tours Layher de 4 mètres de haut sont positionnées en dehors de la zone public et servent de moyens de signalisation pour les toilettes.\

La tour Layher de 8 mètres de haut est elle positionnée au dos du podium interplateau. Elle sera complètement recouverte par des bâches décoratives et sera inaccessible au public.\

Toutes ces tours seront lestées à l'aide de blocs de béton et contrôlées par un bureau de contrôle.\\
...
Les installations électriques sont vérifiées au préalable par un bureau de contrôle et de vérification réglementaire. 
...
Un éclairage de sécurité autonome constitué d'un système de blocs phares est mis en place afin d’assurer le balisage des dégagements en cas de coupure électrique : des projecteurs dotés de batteries sont disposés sur la structure métallique des régies et des scènes afin d’éclairer en cas d’urgence les 13 sorties. \\
...
\begin{list}{•}{}
	...
	\item (A) AFFF (Agent formant un film flottant) : à proximité d’hydrocarbures ou d'huile (ici uniquement au niveau des stands de restauration). Ce type d’extincteur remplace les extincteurs à poudre car il produit les mêmes effets mais évite la création d’un nuage de poudre.
\end{list} \mbox{}\\
...
Une équipe de \textbf{5 agents certifiés SSIAP 1, 2 agents certifiés SSIAP 2 et d’un agent certifié SSIAP 3 (au PC Sécurité)} est présente sur le site de 20 h à 4 h les 17 et 18  mai, et de 20h à 23h le 19 mai 2019. \\
Un Poste de Commandement Incendie est présent dans la bibliothèque Marie Curie. \\

Un agent SSIAP 1 est présent en permanence sur l’emplacement réservé aux Personnes à Mobilité Réduite (PMR) de la grande scène afin de les aider à se diriger vers les issues de secours en cas d’incendie. 
\begin{center}
...
La zone des caisses est une zone dédiée uniquement à la vente de billets pour accéder à la zone principale. Elle est composée d'une file d’attente matérialisée à l’aide de barrières de police de type Vauban qui débouche sur un préfabriqué de caisse. À la suite de l'achat du billet, le festivalier accède aux files d'attente pour entrer dans la Zone de Concerts. Les festivaliers seront invités à acheter leurs billets en amont de la manifestation.
\begin{center}
...
La réglementation de type N indique une densité de \textbf{1 personne/m\up{2}} en cas de restauration assise, \textbf{2 personnes/m\up{2}} en cas de restauration debout, et \textbf{3 personnes/m\up{2}} en file d'attente. Ici nous avons ces trois zones, réparties de la façon suivante :
...
Etant donnée la configuration de notre zone, nous ne pourrons mettre en place qu'un maximum de trois sorties, réparties sur toute la façade est de l'espace de restauration. En revanche, nous avons un total de \textbf{22 UP}, pour un minimum de 15 UP, soit un \textbf{différentiel positif de 7 UP}. 
...
La Scène Root's est une petite scène, sur laquelle sera diffusée de la musique d'un genre alternatif aux deux autres scènes. Cette année, la structure de la scène sera solidaire de la structure formant la canopée comme vous pouvez le voir sur l'image suivante :

\begin{center}
	\includegraphics[width=.8\textwidth,keepaspectratio]{Annexes/Images/SceneRoots}
	\captionof{figure}{Schéma 3D de la structure de la Scène Root's et de la canopée}
\end{center}

La structure matérialisant la scène fera 6m par 6m et le podium, d'une surface équivalente, sera montée à l'aide des praticables de Villeurbanne.\\

Au dessus du public sera tendu un filet de camouflage en lycra ignifugé, reposant sur un cadre en poudre aluminium de 12 mètres de long pour 11 mètres de large. Ce filet a uniquement une fonction décorative. Les piliers supports du cadre seront lestés par une embase lourde. 

\begin{center}
	\includegraphics[width=.8\textwidth,keepaspectratio]{Annexes/Images/Canopee}
	\captionof{figure}{Vue du dessus de la structure de la Scène Root's et de la canopée}
\end{center}
...
\begin{list}{•}{}
	\item le vendredi \textbf{17} mai de \textbf{20h à 3h20}
	\item le samedi \textbf{18} mai de \textbf{13h à 17h} et de \textbf{20h à 3h20}
	\item le dimanche \textbf{19} mai de \textbf{13h à 17h}
\end{list}
...
La scène de l'édition 2019 est sensiblement différente de l'édition 2018. Elle ne sera plus constituée de trois parties mais d'un seul tenant, plus large pour atteindre une superficie équivalente à celle de 2018 (24m par 14,5m).
Cette nouvelle structure permet de gagner un temps précieux lors du montage, et reste résistante au vent jusqu'à \textbf{110 km/h}.
\begin{center}
	\includegraphics[scale=0.40, angle=0]{Annexes/Images/GrandeScene}
...
\subsection{Plan d'installation des tours Layher}
\label{Tour_Layher}

\begin{center}
	\includegraphics[width=.75\textwidth,keepaspectratio]{Exports/Tour_4m_plancher}
	\captionof{figure}{Tour Layher 4m}
\end{center}

\begin{center}
	\includegraphics[width=.75\textwidth,keepaspectratio]{Exports/Tour_8m+plancher}
	\captionof{figure}{Tour Layher 8m}
\end{center}
...
En cas de problème ne pouvant être géré directement par les services de sécurité, le campus accueille d’une part plusieurs infirmeries, et d’autre part bénéficie de la proximité appréciable de la police municipale de Villeurbanne, du centre des pompiers et d'un accès direct au Médipôle Lyon-Villeurbanne par le périphérique. En cas d'incident, le 17 sera contacté avant la police municipale.
\begin{center}
	\includegraphics[scale=0.4]{Annexes/Plans/centreSecours}
...
\begin{list}{•}{}
	...
	\item 2 Responsables Décoration
...
\begin{center}
	\begin{tabular}{ | p{6cm} | p{10cm} | }
		...
		Arthur \textsc{Saunier}, \newline
		Loic \textsc{Jegou} & Coordonner le dispositif de sécurité. Interlocuteurs privilégiés avec STAFF Sécurité, la Croix Rouge Française, les services de Gardiennage INSA et UCBL, le SAMU et les  pompiers. \\ \hline
		Président des 24h :
		
		Ludovic \textsc{Giry} & Interlocuteur privilégié des 24 heures de l'INSA avec les services de police, la mairie et la préfecture. \\ \hline
...
Au moins un responsable sécurité sera présent dans ce PC sans discontinuité. À tout instant, les responsables sécurité, ainsi que le président, seront joignables.\\
...
Cette fermeture est effective du vendredi 17 mai à 18h au dimanche 19 mai à 23h59.\\
...
Du vendredi 17 mai à 18h au dimanche 19 mai à 23h59, la \textbf{condition d’accès} au campus est la suivante (vous trouverez ci-après le plan des points de sécurité du campus) :
\begin{list}{•}{}
	...
	\item Les coureurs des courses vélo et à pied peuvent accéder au campus le vendredi 17 mai entre 18h et 20h ainsi que le samedi 18 mai entre 5h et 10h, dans la mesure où leur nom figure sur les listes d’inscription. Ceux-ci ne peuvent rentrer que par le point d'accès ouest sur le boulevard Laurent Bonnevay (point d'accès 1). Ils seront ensuite redirigés vers un parking dans l’enceinte des courses.
	\item Le point d'accès 2 est réservé aux services de secours.
	\item L’ensemble du barriérage est levé dimanche 19 mai à 23h59, après la fin du feu d’artifice. Les blocs béton obstruant les points d'accès 3 et 6 sont quant à eux retirés entre 00h et 01h le lundi 20 mai.
...
Étant donné la taille du campus et le nombre de véhicules stationnés à l'intérieur de ce périmètre, un second périmètre de sécurité est instauré autour de la zone de plus forte affluence, au niveau des entrées :
...
Deux véhicules banalisés sont placés sur les deux voies d'accès à cette zone. Ces véhicules seront aussi gardés en permanence soit par un agent (pour le véhicule près du PS4), soit par des bénévoles qui se relaient (pour l'autre véhicule). À l'intérieur de ce périmètre, il n'y aura aucun véhicule de stationné, et seul les services de secours et la police seront autorisés à rentrer.

En cas d'intrusion sur le campus, une zone de chicanes est mise en place au nord de la zone sur la Rue des Sport.

\begin{center}
	\includegraphics[width=.8\textwidth,keepaspectratio]{Exports/Plan_24h_45eme-Chicane_nord}
	\captionof{figure}{Chicane zone Nord}
\end{center}

Cet obstacle est composé de trois véhicules banalisés. Ils seront mis en place vendredi soir à partir de 18h et seront retirés dimanche soir.\\
...
Le campus est traversé par les lignes de tramways T1 et T4. Il sera convenu avec l’exploitant du réseau TCL que les conducteurs de tramway soient informés de l’affluence exceptionnelle lors du week-end des 17, 18 et 19 mai 2019.\\
...
Le bâtiment \textbf{Eugène Freyssinet} contient les salles où se trouvent les loges des artistes. \\
...
\paragraph{Du vendredi 17 mai au dimanche 19 mai à 8h00 :}

La Drop Zone sera située sur le terrain stabilisé situé au nord de la zone ERP matérialisée sur le plan qui suit :

\begin{center}
	\includegraphics[scale=0.4]{Annexes/Plans/dropZone}
	\captionof{figure}{Emplacement de la Drop Zone du 17 mai au 19 mai 8h}
\end{center}
...
\paragraph{A partir du dimanche 19 à 8h00}
...
\begin{center}
	...
	\captionof{figure}{Emplacement de la Drop Zone à partir du 19 mai 8h}
\end{center}
...
Ce bénévole sera présent le vendredi 17 mai de 20h à 04h, le samedi 18 mai de 20h à 4h et le dimanche 19 mai de 20h à minuit. \\
...
\subsection{Autorisation du Maire de Villeurbanne de débit temporaire de boissons fermentées non distillées (Licence de 3ème catégorie)}
\begin{center}
A venir.
...
L’accès au festival se fait obligatoirement par la zone billetterie, que le festivalier soit muni d’un billet acheté en prévente ou sur place. Celle-ci est ouverte le vendredi et le samedi de 20h00 à 2h15.\\
...
Les files d’attente sont matérialisées à l’aide de barrières de sécurité. La zone de contrôle des billets est constituée de 6 files de 1m de large, et la zone de caisse d'une seule file de 1m de large. \\
...
Dans les \textbf{Files 1, 2, 3}, après un contrôle visuel des billets et la palpation systématique opérée par un agent de sûreté, les visiteurs accèdent au contrôle des billets. Les billets sont scannés à l’aide de douchettes pour vérifier leur authenticité et que ceux-ci n’ont pas déjà été compostés. À l'issue de ce contrôle, les visiteurs se voient remettre, uniquement le vendredi, un bracelet "Pass 2 soirs".\\
...
\subsection{Règlement intérieur de la Zone de Concerts (version du 15/01/2019)}


\textbf{Article 1.}\hspace{3mm}La nature du projet\\
Le Club des 24 heures  de l’INSA, désigné par la suite «l’Organisation», organise le festival «les 24 heures de l’INSA», dont la quarante-cinquième édition a lieu les 17, 18 et 19 mai 2019 sur le Campus de Lyon Tech - La Doua, 20 avenue Albert Einstein, 69100 Villeurbanne.\\
...
\textbf{6.3}\hspace{3mm}Les détenteurs d’un titre d’accès «Pass 2 soirs» donnant accès aux soirées du 17 et 18 mai se verront remettre un bracelet d’identification. Le port de ce bracelet est obligatoire pendant toute la durée du festival.\\
\textbf{6.4}\hspace{3mm}Toute personne présente sur la Zone de Concerts doit être en mesure de présenter son titre d’accès. Sont considérés comme titres d’accès les bracelets d’identification précités ou les billets papiers ou électroniques. Dans le cas contraire elle pourra être invitée à quitter la zone.\\
\textbf{6.5}\hspace{3mm} Les Festivaliers sont avertis que leur image est susceptible d'être captée et retransmise en direct ou à posteriori et renoncent de fait à leur droit à l'image.\\
...
À noter que bien qu’étant physiquement situés sur le campus, le «Double Mixte», CPE et l’IN2P3 (centre de calculs) sont des établissements privés. Par conséquent, ni les agents de «STAFF Sécurité» ni le service gardiennage de l’INSA ne sont habilités à y intervenir. \\

En cas de signalement de  problèmes sur ces zones, l’équipe sécurité des 24 heures de l'INSA contactera la police.
...
\begin{center}
	\includegraphics[scale=0.65]{Annexes/Documents/ArreteSTAFF}
...
Cette posture Vigipirate est active depuis le 14 décembre et s'applique, sauf événement particulier, jusqu'au 6 mai 2019.\\
...
À ce titre, les responsables sécurité du festival sollicitent au plus tôt nos différents partenaires de longue date afin de leur faire part des nouveautés de l’édition en préparation et ainsi s’assurer que les dispositifs de sécurité et de sûreté prévus sont adaptés et correctement dimensionnés.\\
...
\vspace{0.1cm}
  ...
  - Établir et valider la répartition des agents de sûreté, en concordance avec les nouveautés et en accord avec les expériences passées.}
\vspace{0.1cm}
 \\
 \hline
\vspace{0.1cm}
...
\vspace{0.1cm}
  ...
  \parbox[t]{8cm}{- Présentation du dispositif de sécurité et de sûreté, en particulier les changements.\\
	- Échanges sur les nouvelles mesures à mettre en place.}
\vspace{0.1cm}
 \\
 \hline
\vspace{0.1cm}
...
%Je pense qu'il y en a en plus à rajouter
  ...
  - Identifier le rôle de chaque acteurs en cas de gestion de crise}
\vspace{0.1cm}
 \\
 \hline
\vspace{0.1cm}
...
Plusieurs mois avant la manifestation, le présent Dossier Sécurité est établi, avec l'aide de la Direction de l'INSA Lyon et des services publics, et ce afin d'identifier et de réduire au maximum en amont tout risques de menace pouvant survenir durant le festival.\\
...
\begin{list}{•}{}
	...
	\item des messages d'évacuation visuels et sonores sont pré-enregistrés afin d'être diffusés sur ordre du PC Sécurité au niveau des enceintes et écrans des scènes du festival lorsque l'ordre d'évacuer la zone est donné.\\
\end{list}
...
\begin{list}{•}{}
	\item Le campus est fermé à la circulation par arrêté du Directeur de l'INSA Lyon, du vendredi 17 mai 18h00 au dimanche 19 mai 23h59. Des barrages gardés par des bénévoles sont installés au niveau de quatre des six voies de circulation permettant d'entrer sur le campus. Ceux-ci sont munis d'une liaison radio permanente avec le PC Sécurité et ont pour consigne de ne laisser passer que les véhicules de secours ou les véhicules munis d'un laissez-passer délivré en amont par les responsables sécurité. La procédure mise en place pour les laissez-passer nécessite que le nom du conducteur corresponde avec les informations obtenues en amont. Sur les deux dernières voies, l'accès est impossible pour tout type de véhicules car elles sont condamnées par des plots en béton. Des bénévoles sont néanmoins en poste pour guider les secours si nécéssaire. Les voitures stationnées aux abords immédiats de la zone seront évacuées avant l'ouverture de la zone ERP. De plus, entre 20h et 5h du matin les vendredi et samedi soir, des véhicules de type Kangoo sont placés en travers de la route des quatre barrages, empêchant ainsi l'intrusion volontaire de conducteurs mal intentionnés.
	\item Les bâtiments aux abords de la zone sont fermés par les services de sécurité de l'INSA Lyon, après vérification qu'ils sont vides, le vendredi 17 mai à 19h00. Les accès standards, par badge, sont désactivés, et les autorisations d'accès sont nominatives et accordées en amont de la manifestation aux personnes nécessitant un accès.
...
\begin{list}{•}{}
	...
	\item La zone billetterie est équipée de six couloirs de contrôle. Ce dispositif ainsi dimensionné a fait ses preuves lors des deux dernières éditions puisque nous n'avons pas relevé d'engorgement aux entrées durant toute la durée d'ouverture de la zone. Le dispositif est donc reconduit pour cette édition et est rappelé figure \ref{etapes_entrees}, page \pageref{etapes_entrees}.
...
Dans cette partie, nous reprenons les mesures présentées dans les fiches techniques concernant la prévention applicables à notre événement.
\begin{center}
...
\shrinkheight{1cm} 
  ...
  - Les bâtiments et les salles non utilisés sont fermés à clés par la direction du patrimoine le vendredi à 19h00\\}
 \\
 \hline
  N° 3 &
  \parbox[t]{4cm}{Contrôler l'accès et maintenir l'ordre dans les files d'attentes} & 
  \parbox[t]{10cm}{- La file d'attente pour l'achat de billets sur place est séparée de celles pour l'accès au site.\\
 ...
 \hline
  ...
  \parbox[t]{10cm}{- Le compte Twitter "Beauvau\char`_Alertes" est consulté en permanence pour recevoir et relayer les alertes.\\
	- Nous sommes connectés au système d'alerte par SMS de l'Université Claude Bernard Lyon 1 pour recevoir et relayer les alertes.}
 \\
 \hline 
\end{tabular}
\end{center}
...
La nourriture qui y est préparée et vendue peut être (liste non exhaustive) :
\begin{list}{•}{}
...
\begin{list}{•}{}
	...
	\item Samedi de 10h à 18h et de 20h 3h45
	\item Dimanche de 10h à 18h et de 20h à 23h30
...
À noter qu'un point d'eau potable est mis à disposition des prestataires, à proximité immédiate des lieux de préparation.
...
Tous les équipements et toutes les tenues utilisés doivent être propres et en état.
...
\begin{center}
\includegraphics[scale=0.7]{Annexes/Documents/INSAAutorisationFeuArtifice&SpectacleDeFeu}
...
\begin{center}
\includegraphics[scale=0.72]{Annexes/Documents/INSAAutorisationCourses}
...
- Éclairage de la chaussée sur tout le parcours de nuit
...
- Les blessés graves éventuels sont pris en charge par les secouristes et transférés à l'infirmerie. Après évaluation des blessures, les pompiers sont contactés pour évacuation vers le Médipôle Lyon-Villeurbanne ou l'hôpital Edouard Herriot.
 \\ \hline
...
- Éclairage de la chaussée sur tout le parcours de nuit & Voir les Procédures d’arrêt de la course \\ \hline
...
Pendant toute la course un \textbf{véhicule de la Croix-Rouge} est posté sur le circuit accompagné de \textbf{3 secouristes}, afin de pouvoir intervenir le plus rapidement possible en cas d’incident sur le parcours. \\
...
\item Intervention de la Croix Rouge pour évacuation des blessés éventuels, dégagement du circuit (spectateurs)
...
\item Obstacles très volumineux et coupant, glissant ou dangereux de toute autre manière
...
\item Signalement de l’incident sur tout le parcours par le biais des haut-parleurs (village coureur)
\item Intervention de la Croix Rouge et du SAMU ou des pompiers si besoin pour évacuation des blessés éventuels, dégagement du circuit (spectateurs).
\item Reprise de la course au point spécifié
\item Signalement de la fin de l’incident sur tout le parcours par le biais des haut-parleurs (village coureur)
\end{list}
...
\item Blocage du point de passage et de ceux à proximité par les bénévoles
\item Maintien du calme dans la foule par les agents de sûreté
\item Intervention de la Croix Rouge, et si besoin du SAMU et des pompiers pour évacuation des blessés éventuels, dégagement du circuit (spectateurs)
\item Reprise de la course au point spécifié et en amont
\item Dégagement du circuit (coureurs cyclistes)
\item Réouverture des points de passage
\item Signalement de la fin de l’incident sur tout le parcours par le biais des haut-parleurs (village coureur)
...
Les concurrents commencent à la piscine de l’INSA par 4 heures de natation ; puis enchainent avec une épreuve de 14 heures de vélo pour terminer par 6 heures de course à pieds. L'ensemble de l'épreuve est réalisé en équipe de 3 personnes maximum. L’objectif étant de parcourir la plus grande distance en 24 heures de course au total.\\
...
Le gymnase Colette Besson est aménagé pour des coureurs, comprenant stand de massage encadré par un kinésithérapeute et un médecin, un point de ravitaillement, ainsi qu’un accès à des douches et des sanitaires.\\
...
\begin{center}
\includegraphics[width=1.2\textwidth,keepaspectratio,angle=90]{Exports/Plan_24h_45eme-Parcours_courses}
...
\item Jeux en bois
\item Combat de sumo 
\item Combat de joutes
\item Chateaux gonflables
\item Piscine à balles
\item Babyfoot humain
\item Parcour gonflable Pirates
...
\item Stand de Musique pour tous
\item Exposition photos
\item Jeu de piste
\item Stand Maquillage
\item Stand Origami
\end{itemize}
...
À partir de 19h30, les agents se postent aux différents accès à la Zone Sud où se trouve la grande scène (l’accès sud se fait par la sortie, la zone des caisses est condamnée) 
...
Une bobine Tesla est une machine électrique permettant d'atteindre de très hautes tensions et donc de produire des éclairs. Pour plus d'informations, veuillez vous référer au dossier Bobine Tesla en annexe.
\begin{center}
...
\hline
	...
	Brève description de l'activité & Un spectacle de feu sera organisé le dimanche soir afin d’attirer les gens pour le feu d’artifice. En plus de jongleurs, une bobine Tesla sera installée en arrière plan. \\ \hline
	Remarques & Les membres du club de l’AJIL (INSA) font des démonstrations de jonglerie entre le public et le feu d’artifice, en restant en dehors du périmètre de sécurité, et éloignés de la foule. La bobine Tesla sera installée à distance suffisante du feu d'artifice, des jongleurs et du public pour assurer le bon déroulement de l'animation. Les élèves ingénieurs responsables de la bobine resteront tout au long du spectacle pour assurer son bon fonctionnement. \\ \hline
	Nombre d’agents demandés + horaires
...
\begin{center}
\includegraphics[width=.8\textwidth,keepaspectratio]{Annexes/Documents/INSAAutorisationFeuArtifice&SpectacleDeFeu}
...
Ce sont des micros propulseurs enfermés dans une mallette fermée par un cadenas. Les explosifs sont de classe K1, ce qui n’implique pas de restriction d’âge. La fusée est rendue opérationnelle par les personnes de l’association formées à cela.

Le dispositif de lancement présente un interrupteur à clé, le bouton n’est activé que si la clé est dedans.
Chaque fusée possède un parachute pour freiner sa descente. Un périmètre de sécurité est respecté, il correspond à l’ensemble du terrain de football, ce qui est largement suffisant au vue de la portée des fusées. Le public se trouve à plus de 25 m du pas de tir.
...
\subsection{Kart à pédales}
\label{kart_a_pedales}

\subsubsection{Fiche sécurité}
\begin{center}
\begin{tabular}{ | p{6cm} | p{10cm} | }
\hline
	\multicolumn{2}{|l|}{Karts à pédales}  \\ \hline
	Horaires & Samedi et dimanche 10h – 18h \\ \hline
	Lieu & Terrain de tennis de Colette Besson\\ \hline
	Commission & Animations \\ \hline
	Responsable de l'activité & KV Events 06 21 09 80 52 \\ \hline
	Correspondant 24h & Pedro Guedes 07 83 70 31 77 \\ \hline
	Brève description de l'activité & Course de karts à pédales sur un circuit délimité par une structure gonflable. \\ \hline
	Remarques & - \\ \hline
	Analyse des risques
...
\subsection{Combat de sumo}

\subsubsection{Fiche sécurité}
\begin{center}
\begin{tabular}{ | p{6cm} | p{10cm} | }
\hline
	\multicolumn{2}{|l|}{Combat de sumo}  \\ \hline
	Horaires & Samedi et dimanche 10h – 18h \\ \hline
	Lieu & Rond point Nord \\ \hline
	Commission & Animations \\ \hline
	Responsable de l'activité & KV Events 06 21 09 80 52 \\ \hline
	Correspondant 24h & Yanaël Galliache-Pagnot 07 83 95 50 79 \\ \hline
	Brève description de l'activité & Les participants sont équipés de combinaisons rembourrées et doivent se mettre au sol.\\ \hline
	Remarques & Adapté aux enfants et adultes.\\ \hline
	Analyse des risques
	
Matériel et dispositions de sécurité & La zone de jeu et la file d'attente seront délimitées par des barrières Vauban. L'animation se déroulera sous la supervision d'un encadrant bénévole. \\ \hline
\end{tabular}
...
\hline
	...
	Correspondant 24h & Christophe Monnier 06 45 88 70 62  \\ \hline
...
TEL : 06 84 20 73 57\\
contact@meygalosport.fr\\
Site : www.meygalosport.fr\\
\end{center}

\begin{center}
\includegraphics[width=.8\textwidth,keepaspectratio]{Annexes/Documents/Attestation-conformite-Mur}
\captionof{figure}{Attestation de conformité de la structure}

\includegraphics[width=.8\textwidth,keepaspectratio]{Annexes/Documents/Attestation-EPI-Mur}
\captionof{figure}{Attestation de suivi des EPI}

\includegraphics[width=.8\textwidth,keepaspectratio]{Annexes/Documents/Attestation-RC-Mur}
\captionof{figure}{Attestation d'assurance de l'exploitant}

\includegraphics[width=.8\textwidth,keepaspectratio]{Annexes/Documents/Diplome-Moniteur-Mur}
\captionof{figure}{Attestation d'assurance de l'exploitant}
\end{center}
...
\begin{center}
	\begin{tabular}{ | p{6cm} | p{10cm} | }
	\hline
		\multicolumn{2}{|l|}{Mur d'escalade}  \\ \hline
		Horaires & Samedi 10h – 18h \\ \hline
		Lieu & A l'Ouest du  rond-point Avenue des Arts - Rue des Sports\\ \hline 
		Commission & Animation \\ \hline
		Responsable de l'activité & Entreprise Meygalosport 06 84 20 73 57 \\ \hline
		Correspondant 24h & Emeric Pele 06 74 65 78 29  \\ \hline
		Brève description de l'activité & Mur d'escalade à cordes\\ \hline
		Remarques & Les grimpeurs seront assurés par le prestataire diplômé du BPJEPS APT. \\ \hline
		Analyse des risques
		
	Matériel et dispositions de sécurité & Risques d'écorchage ou de chute. EPIs fournis par le prestataire. \\ \hline
	\end{tabular}
...
\hline
	...
	8. ÉTABLISSEMENTS D’HÉBERGEMENT HOTELIER &  &  & X \\ \hline
	9. INSTALLATIONS SPORTIVES SOCIO-EDUCATIVES &  &  & X \\ \hline
	10. ÉTABLISSEMENTS DE MAGASINS DE VENTE &  &  & X \\ \hline
\end{tabular}
...
Du vendredi 17 mai 18h au dimanche 19 mai 23h59, le campus sera fermé à la circulation, cependant un parking sera aménagé et réservé pour accueillir les Personnes à Mobilité Réduite (PMR) se déplaçant en voiture. L’accès au campus des PMR ne pourra se faire que par le PS5 (avenue Gaston Berger). Sur le campus, de nombreux stationnements réservés aux PMR sont disponibles, mais ces derniers seront redirigés en priorité vers le parking de la bibliothèque, le plus proche de la zone.
...
Si ces places sont occupées, les PMR seront pris en charge par un bénévole dès l’entrée sur le campus. Le membre de l’organisation les dirigera vers d’autres parcs de stationnement réservés aux PMR, puis aidera la personne à rejoindre la Zone de Concerts si nécessaire. En cas d’impossibilité, il fera appel à un autre membre de l’organisation par liaison radio.

\begin{center}
\includegraphics[scale=1]{Annexes/Images/parkingPMRDOUA}
\captionof{figure}{Répartition des parkings PMR sur la campus de la Doua}
\end{center}

La sortie du véhicule se fera elle aussi par l'avenue Gaston Berger.

\section{Entrée et sortie de la zone ERP}
L’accès aux PMR en soirée sera différencié en fonction de si la personne a déjà acheté son billet ou non.
...
Avant de pouvoir accéder à la Zone de Concerts, ces personnes vont devoir passer par la zone des caisses pour acheter un billet d’entrée. À l’arrivée à la zone des caisses, elles seront prises en charge par un agent qui les accompagnera au niveau des caisses puis les fera entrer dans la zone, en suivant le parcours suivant :
...
Cette structure surélevée accueillera deux espaces : un espace réservé aux Personnes à Mobilité Réduite, un espace réservé aux VIP. Le plateau de repos mesure 6m x 4m sur lequel une zone de 6m x 1.5m permettant d'accueillir 7 fauteuils (emcombrement estimé par fauteuil de 0.8m x 1.5m), sera délimitée par un marquage au sol, et réservé pour les PMR. Un garde-corps de 90 cm est dressé sur l'ensemble du périmètre de la plateforme.
...
\end{center}
\begin{center}
\includegraphics[scale=0.4]{Annexes/Images/structurePMRDessus}
\captionof{figure}{Structure PMR, vue de dessus}
\end{center}
% \begin{center}
% \includegraphics[scale=0.4]{Annexes/Images/structurePMR3D}
...
Notes : 
\begin{list}{•}{}
\item La petite scène, se trouve au nord de la zone ERP étant posée sur un parking et attirant beaucoup moins de public, les Personnes à Mobilité Réduite ne seront pas gênées si elles souhaitent assister au concert.
...
Afin de satisfaire les Personnes à Mobilité Réduite, plusieurs solutions leurs sont données pour profiter des différents services (caisses, accueil, buvettes, restauration).
\begin{list}{•}{}
...
Cette structure fait au maximum 0,80 mètre de haut, a un vide en partie inférieure d’au moins 0,30 m de profondeur, 0,60 m de largeur et 0,70 m de hauteur pour permettre le passage des pieds et des genoux d’une personne en fauteuil roulant.\\
...
Dans la continuité des éditions précédentes, les Personnes à Mobilité Réduite auront à disposition des toilettes adaptées. Elles seront situées au sud de la structure PMR pour voir les concerts de la grande scène, le tout en conformité avec la circulaire interministérielle DGUHC 2007-53 du 30/11/1997.\\

La structure est munie d’un dispositif permettant de fermer la porte derrière soi une fois rentré, comporte un lave-mains dont le plan supérieur est situé à une hauteur maximale de 0,85 m, a une surface d’assise de la cuvette comprise entre 0,45 et 0,50 m et est munie d’une barre d’appui latérale capable de supporter le poids d’un adulte, fixée à une hauteur comprise entre 0,7 et 0,8 m.\\
...
À venir.
% \begin{center}
% \includegraphics[scale=0.7]{Annexes/Documents/INSAAutorisationPrincipe}
...
% \captionof{figure}{Autorisation à la tenue du Grand Rassemblement pour le festival des 24 heures de l'INSA}
% \end{center}
...
\begin{center}
\includepdf[pages=-]{Annexes/Documents/Dossier_bobine_tesla.pdf}
\captionof{figure}{Dossier Bobine Tesla}	
\end{center}
